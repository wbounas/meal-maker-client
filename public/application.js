...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {// instruct browser to use Strict mode, a reduced and safer feature set of JS
...
var deleteIngredient = function deleteIngredient(data) {
  return $.ajax({
...
var updateIngredient = function updateIngredient(data, ingID) {
  return $.ajax({
...
var store = __webpack_require__(3);
var showIngsTemplate = __webpack_require__(19);
var modalMaker = __webpack_require__(37);
var api = __webpack_require__(5);

var createIngredientSuccess = function createIngredientSuccess(data) {
  ...
  api.getIngredients().then(getIngsSuccess).catch(getIngsFailure);
};
...
var createIngredientFailure = function createIngredientFailure(error) {
  ...
  $('.create-ing-msg').css('margin', '0 auto');
  setTimeout(function () {
    $('.create-ing-msg').css('display', 'none');
  }, 3500);
  setTimeout(function () {
    $('.create-ing-msg').html('');
  }, 3500);
...
var deleteIngredientSuccess = function deleteIngredientSuccess(button) {
  // remove the <ul> from handlebars that contains the ingredient whose child had the remove button
  $(button).parents('tr').empty();
};

var deleteIngredientFailure = function deleteIngredientFailure(error) {
  // console.log('ERROR has occurred, please see below')
  console.error(error);
};

var getIngsSuccess = function getIngsSuccess(data) {
  ...
  var showIngsHtml = showIngsTemplate({ ingredients: data.ingredients });
  var makeModal = modalMaker({ ingredients: data.ingredients });

  var checkStoreIngredientsEmpty = function checkStoreIngredientsEmpty(storedIngredients) {
...
var getIngsFailure = function getIngsFailure(error) {
  // console.log('ERROR please see below')
  console.error(error);
};

var updateIngredientSuccess = function updateIngredientSuccess(data) {
...
var updateIngredientFailure = function updateIngredientFailure(error) {
  // console.log('ERROR please see below')
  console.error(error);
  ...
  $('.update-ing-msg').css('margin', '0 auto');
  setTimeout(function () {
    $('.update-ing-msg').css('display', 'none');
  }, 3500);
  setTimeout(function () {
    $('.update-ing-msg').html('');
  }, 3500);
  setTimeout(function () {
    $('.update-ingredient-form').trigger('reset');
  }, 3500);
};
...
module.exports = {
  ...
  getIngsSuccess: getIngsSuccess,
  getIngsFailure: getIngsFailure,
  updateIngredientSuccess: updateIngredientSuccess,
  updateIngredientFailure: updateIngredientFailure
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var ingEvents = __webpack_require__(38);
var octicons = __webpack_require__(39);
...
var onSignIn = function onSignIn(event) {
  var data = getFormFields(this); // data is stored as a "credentials" JSON array containing 'email' and 'password' key/value pairs
  event.preventDefault();
  // // console.log('hello world! data is:', data)
...
var store = __webpack_require__(3);
var apiIngredients = __webpack_require__(5);
var uiIngredients = __webpack_require__(9);
...
var signInSuccess = function signInSuccess(data) {
  ...
  }, 2000); // remove sign-in dropdown after 2000 ml-sec
  setTimeout(function () {
    $('#logged-in-dropdown').css('display', 'inline-block');
  }, 2000); // show account-nav dropdown after 2000 ml-sec
  setTimeout(function () {
    $('.account-nav').css('display', 'block');
  }, 2000);
  setTimeout(function () {
    $('.sign-in-msg').css('display', 'none');
  }, 3500); // set display: none; for ui messaging
  setTimeout(function () {
    $('.sign-in-msg').html('');
  }, 3500); // remove html content from ui messaging
  ...
  setTimeout(function () {
    $('.create-ingredient-test-container').css('display', 'inline-block');
  }, 1000);
  setTimeout(function () {
    $('.create-ing-msg').css('background', '#fff');
  }, 1000);
  ...
  apiIngredients.getIngredients().then(uiIngredients.getIngsSuccess).catch(uiIngredients.getIngsFailure);
};
...
var changePasswordSuccess = function changePasswordSuccess(data) {
  ...
  setTimeout(function () {
    $('.account-nav-msg').css('display', 'none');
  }, 3500);
  setTimeout(function () {
    $('.account-nav-msg').html('');
  }, 3500);
};
...
var signOutSuccess = function signOutSuccess(data) {
  ...
  }, 250); // set navbar-msg after 2000 ml-sec
  setTimeout(function () {
    $('#logged-in-user-email').html('SIGNED OUT');
  }, 250); // set navbar-msg after 2000 ml-sec
  setTimeout(function () {
    $('#sign-in-msg').html('');
  }, 2000); // clear sign-in ui messaging
  setTimeout(function () {
    $('#sign-in-msg').css('display', 'none');
  }, 2000); // remove sign-in ui messaging
  setTimeout(function () {
    $('.account-nav-msg').css('display', 'none');
  }, 1000); // set display: none; for ui messaging
  setTimeout(function () {
    $('.account-nav-msg').html('');
  }, 3500); // remove html content from ui messaging
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "    <tr>\n      <td data-id=\""
    ...
    + "      </td>\n      <td><button type=\"button\" class=\"btn btn-warning update-btn\"\n        data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\"\n        data-name=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\"\n        data-unit=\""
    ...
    + "\"\n        data-notes=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1), depth0))
    + "\">\n        Update/Change\n      </button></td>\n      <td><button class=\"btn btn-danger remove-ing\">Remove</button></td>\n    </tr>\n";
  ...
  return "  <!-- "
    + ((stack1 = container.invokePartial(__webpack_require__(36),depth0,{"name":"partial","data":data,"blockParams":blockParams,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
    + " -->\n  <!-- NOTE: 'partial' can be named anything, as long as the filename is named the same! -->\n  <!-- Don't uncomment yet -->\n\n <!-- Developers, why are we using data-id and not just id? -->\n\n\n<table class=\"table table-striped\" id=\"fridge-table\">\n  <thead>\n    <tr>\n      <th>Ingredient ID</th>\n      <th>Ingredient Name</th>\n      <th>Unit</th>\n      <th>Quantity</th>\n      <th>Notes</th>\n      <th>Update</th>\n      <th>Remove</th>\n    </tr>\n  </thead>\n  <tbody>\n"
    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.ingredients : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "  </tbody>\n</table>\n";
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n<!-- UPDATE-INGREDIENT Modal -->\n<div class=\"modal fade\" id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"exampleModalLabel\" aria-hidden=\"true\">\n  <div class=\"modal-dialog sign-in-modal\" role=\"document\">\n    <div class=\"modal-content\">\n      <div class=\"modal-body\">\n\n        <!-- UDPATE-INGREDIENT container -->\n        <div class=\"update-ingredient-container\">\n\n          <h2 class=\"sign-up-header\">Update your Ingredient!</h2>\n          <p class=\"update-ing-msg\"</p>\n\n          <form role=\"form\" class=\"update-ingredient-form\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n            <div class=\"form-group\">\n              <input name=\"ingredient[name]\" type=\"text\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
    + "\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"update-ingredient-unit\">Ingredient Unit</label>\n              <input name=\"ingredient[unit]\" type=\"text\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.unit : stack1), depth0))
    + "\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"update-ingredient-quantity\">Ingredient Quantity</label>\n              <input name=\"ingredient[quantity]\" type=\"number\" class=\"form-control\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1), depth0))
    + "\">\n            </div>\n            <div class=\"form-group\">\n              <label for=\"update-ingredient-notes\">Ingredient Notes</label>\n              <input name=\"ingredient[notes]\" type=\"text\" class=\"form-control\" "
    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : (container.nullContext || {}),((stack1 = blockParams[0][0]) != null ? stack1.notes : stack1),{"name":"if","hash":{},"fn":container.program(2, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + ">\n            </div>\n            <button type=\"submit\" class=\"btn btn-default update-ingredient-btn\">Update an Ingredient in your Fridge!</button>\n          </form>\n\n        </div>\n        <!-- END UDPATE-INGREDIENT container -->\n\n      </div>\n    </div>\n  </div>\n</div>\n  <!-- END of UPDATE-INGREDIENT modal -->\n\n";
},"2":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
  ...
  return "\n                value=\""
    ...
    return "                placeholder=\"No notes provided.\"\n              ";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;
...
var onCreateIngredient = function onCreateIngredient(event) {
  var data = getFormFields(this); // data becomes a JSON object "ingredient" with key/value pairs based on the 'name' of each field in the form e.g. ingredient[form-field-name]
  ...
  .then(ui.createIngredientSuccess).catch(ui.createIngredientFailure);
};
...
var onDeleteIngredient = function onDeleteIngredient(event) {
  ...
  var data = $(this).parents('td').siblings('td').data('id'); // this is the ingredient's ID based on the data-id of the parent <ul> from handlebars
  // console.log('in onDeleteIngredient, data is:', data)
  var fridgeRemoveBtn = event.target; // event.target is the button
...
var getUpdateItemInfo = function getUpdateItemInfo(event) {
  // console.log('inside getUpdateItemInfo, this is:', this)
  var ingID = $(this).data('id'); // gives you ingredient.id of parent <ul> to update-btn
  var ingNAME = $(this).data('name'); // gives you ingredient.name
  var ingUNIT = $(this).data('unit'); // gives you ingredient.unit
  var ingQUANTITY = $(this).data('quantity'); // gives you ingredient.quantity
  var ingNOTES = $(this).data('notes'); // gives you ingredient.notes
...
var onSubmitUpdateIngredient = function onSubmitUpdateIngredient(event) {
  event.preventDefault();
  ...
  .then(ui.updateIngredientSuccess).catch(ui.updateIngredientFailure);
};
...
var octicons = __webpack_require__(41);
